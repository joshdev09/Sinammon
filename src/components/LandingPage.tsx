...
function Navbar() {
  ...
  return (
    <nav className="flex flex-row px-4 sm:px-6 py-3 sm:py-4 bg-[#333333] items-center justify-between relative z-50">
      ...
      {/* Desktop nav links */}
      <ul className="hidden lg:flex flex-row gap-8 text-white font-medium text-sm list-none">
        <li className="cursor-pointer hover:opacity-70 transition-opacity">Tools</li>
        <li className="cursor-pointer hover:opacity-70 transition-opacity">About</li>
        <li className="cursor-pointer hover:opacity-70 transition-opacity">DepEd Commons OERs</li>
        <li className="cursor-pointer hover:opacity-70 transition-opacity">Ai Tools</li>
      </ul>
      ...
      {/* Mobile hamburger */}
      <button
        className="sm:hidden p-2 text-white hover:opacity-70 transition-opacity"
